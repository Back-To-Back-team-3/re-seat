  ...
  return (
    <section className="mx-auto w-[min(820px,100%)]">
      ...
      >
        ...
        <div className="mb-7 grid grid-cols-2 border-t border-b border-border py-5 max-sm:grid-cols-1 max-sm:gap-3">
          <div className="grid gap-1 border-r border-border max-sm:border-r-0 max-sm:border-b max-sm:pb-3 max-sm:text-left">
      ...
      <div className="mt-3.5 flex gap-3 rounded-[10px] border border-border bg-surface-soft px-[18px] py-[15px]">
        <span className="grid size-[22px] shrink-0 place-items-center rounded-full bg-foreground font-serif text-xs font-black text-surface">
          i
        </span>
