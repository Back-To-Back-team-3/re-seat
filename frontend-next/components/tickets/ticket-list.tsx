...
export function TicketList({
  ...
  return (
    <section className="mx-auto w-full max-w-[1120px]">
      ...
      {source === "mock" && (
        <div className="my-[18px] flex items-center gap-2.5 rounded-control border border-[rgba(245,166,35,0.35)] bg-[rgba(245,166,35,0.08)] px-[14px] py-3 text-xs text-muted-foreground">
          ...
          {tickets.map((ticket) => {
            ...
            return (
              <article
                ...
                key={ticket.ticketId}
              >
                <div className="grid place-items-center content-center gap-[7px] bg-foreground text-surface">
                ...
                <div className="grid place-items-center content-center gap-2 border-l border-dashed border-border max-[640px]:col-span-2 max-[640px]:min-h-[100px] max-[640px]:border-t max-[640px]:border-l-0">
