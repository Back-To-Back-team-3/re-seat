    ...
    <>
      ...
      {auth.isAuthed && !auth.isVerified ? (
        ...
        <>
          ...
          */}
          <section className="relative mx-auto grid w-full max-w-[var(--width-shell)] min-h-[660px] grid-cols-[minmax(0,1.08fr)_minmax(390px,0.92fr)] gap-[34px] overflow-hidden bg-[radial-gradient(circle_at_78%_38%,rgba(224,53,53,0.1),transparent_34%)] pr-[7vw] max-[1024px]:grid-cols-1 max-[1024px]:pr-0">
