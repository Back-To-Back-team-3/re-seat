...
export function TodayGamesPanel({
  ...
  return (
    <section className="relative z-[2] overflow-hidden rounded-[18px] border border-border bg-surface/94 shadow-card backdrop-blur-[18px]">
      <div className="flex items-center justify-between gap-4 border-b border-border px-5 py-[17px] max-sm:flex-col max-sm:items-start max-sm:gap-[3px]">
