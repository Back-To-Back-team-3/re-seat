...
export function SeatMap({
  ...
  return (
    <div className="col-start-1 row-start-2 overflow-hidden rounded-panel border border-border bg-surface max-[1024px]:col-start-auto max-[1024px]:row-start-auto">
      ...
      {seatRows.length === 0 ? (
        ...
        <div className="max-h-[650px] overflow-auto p-5 max-[640px]:px-[10px] max-[640px]:py-4">
          <div className="mx-auto mb-7 w-[76%] rounded-[50%_50%_7px_7px] bg-surface-soft p-[7px] text-center font-mono text-[7px] tracking-[2px] text-muted-foreground">
            그라운드 방향
          </div>
