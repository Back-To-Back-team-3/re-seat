...
export function Footer() {
    return (
        <footer
            className="grid grid-cols-[2fr_1fr_1fr_1.3fr] gap-10 border-t border-border bg-surface px-[7vw] py-12 max-[900px]:grid-cols-2 max-sm:grid-cols-1 max-sm:px-6 max-sm:py-[38px]">
