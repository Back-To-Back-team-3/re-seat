...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 grid min-h-[70px] grid-cols-[auto_1fr_auto] items-center border-b border-border bg-background/92 px-[var(--gutter-desktop)] shadow-[0_1px_12px_rgb(0_0_0/4%)] backdrop-blur-lg max-[900px]:px-6 max-sm:min-h-[62px] max-sm:px-[var(--gutter-mobile)]">
      <Link
