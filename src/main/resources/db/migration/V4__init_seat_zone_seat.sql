...
-- 3) 좌석 구역 10개 시드
INSERT INTO seat_zones (stadium_id, name, grade, base_price) VALUES
                                                                 (1, '101', 'INFIELD',  18000),
                                                                 (1, '102', 'INFIELD',  18000),
                                                                 (1, '103', 'INFIELD',  18000),
                                                                 (1, '301', 'INFIELD',  18000),
...
FROM seat_zones z
         CROSS JOIN (
    SELECT 'A' AS seat_row UNION ALL SELECT 'B' UNION ALL SELECT 'C' UNION ALL SELECT 'D' UNION ALL SELECT 'E'
) r
         CROSS JOIN (
