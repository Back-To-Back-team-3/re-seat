...
public class OrderController implements OrderControllerDocs {
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> createOrder(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success("주문 생성", response));
    }
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> getOrder(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("주문 조회", response));
    }
    ...
    public ResponseEntity<ApiResponse<OrderCancelResponse>> cancelOrder(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("주문 취소", response));
    }
}
