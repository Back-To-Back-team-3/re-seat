...
public class UserController {
	...
	public ResponseEntity<ApiResponse<UserSignUpResponse>> signup(@Valid @RequestBody UserSignUpRequest request) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success("회원가입 완료", response));
	...
	public ResponseEntity<ApiResponse<UserProfileResponse>> getMyProfile(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("내 정보 조회 완료", response));
	}
	...
	public ResponseEntity<ApiResponse<Void>> updateMyProfile(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("회원정보 수정 완료", null));
	}
	...
	public ResponseEntity<ApiResponse<Void>> changePassword(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("비밀번호 변경 완료", null));
	}

	@DeleteMapping("/users/me")
	public ResponseEntity<ApiResponse<Void>> withdraw(@AuthenticationPrincipal CustomUserDetails customUser) {
		userService.withdraw(customUser.getId());

		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("회원 탈퇴 완료", null));
	}
}
