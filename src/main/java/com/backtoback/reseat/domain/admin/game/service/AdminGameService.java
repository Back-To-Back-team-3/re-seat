...
import com.backtoback.reseat.domain.admin.game.dto.response.AdminGameResponse;
...
public class AdminGameService {
    ...
    @Transactional
    public AdminGameResponse registerGame(AdminGameRegisterRequest request) {
        ...
        return AdminGameResponse.from(saved);
    }
}
