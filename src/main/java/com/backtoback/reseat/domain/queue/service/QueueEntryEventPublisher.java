...
public class QueueEntryEventPublisher {
	 ...
	 * @return Kafka 발행 결과
	 */
	public CompletableFuture<SendResult<String, QueueEntryRequestedEvent>> publish(QueueEntryRequestedEvent event) {
		...
		return kafkaTemplate
		    .send(KafkaConfig.QUEUE_ENTRY_REQUESTED_TOPIC, messageKey, event)
