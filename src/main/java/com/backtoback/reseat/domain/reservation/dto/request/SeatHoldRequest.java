...
public record SeatHoldRequest(
    ...
    @Schema(description = "경기 ID", example = "1146") @NotNull(message = "gameId는 필수입니다.") @Positive(message = "gameId는 양수여야 합니다.")
    Long gameId,
     ...
     */
    @Schema(description = "선점할 경기 좌석 재고 ID 목록 (game_seats.id)", example = "[5001, 5002]") @NotEmpty(message = "gameSeatIds는 1개 이상이어야 합니다.") @Size(min = 1, max = 2, message = "좌석은 최소 1개, 최대 2개까지 선점 가능합니다.")
