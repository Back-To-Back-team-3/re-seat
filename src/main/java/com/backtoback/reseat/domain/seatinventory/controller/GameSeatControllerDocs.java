...
public interface GameSeatControllerDocs {
    ...
    @Operation(summary = "경기 좌석 현황 조회", description = """
        경기의 좌석 현황을 조회한다.
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "좌석 현황 조회 성공", content = @Content(examples = @ExampleObject(name = "좌석 현황 조회 성공 예시", value = """
            {
                "success": true,
                "message": "좌석 현황 조회 성공",
                "data": [
            ...
            """))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "UNAUTHORIZED — JWT 누락 또는 만료", content = @Content(examples = @ExampleObject(name = "인증 실패 예시", value = """
            {
                "success": false,
            ...
            """))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "QUEUE_TOKEN_REQUIRED / QUEUE_TOKEN_INVALID", content = @Content(examples = @ExampleObject(name = "Queue-Token 오류 예시", value = """
            {
                "success": false,
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "GAME_NOT_FOUND — 미존재 gameId", content = @Content(examples = @ExampleObject(name = "경기 없음 예시", value = """
            ...
            """))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "SEAT_INVENTORY_NOT_OPENED — 재고 미오픈", content = @Content(examples = @ExampleObject(name = "재고 미오픈 예시", value = """
            {
                "success": false,
    ...
    ResponseEntity<com.backtoback.reseat.global.common.ApiResponse<List<SeatStatusResponse>>> getSeats(
        ...
        @Parameter(description = "좌석 등급 (선택)", schema = @io.swagger.v3.oas.annotations.media.Schema(allowableValues = {
            "INFIELD", "OUTFIELD"}))
        SeatGrade grade,

        @Parameter(description = "좌석 상태 (선택)", schema = @io.swagger.v3.oas.annotations.media.Schema(allowableValues = {
    ...
    @Operation(summary = "경기 구역별 잔여 좌석 조회", description = """
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "구역 요약 조회 성공", content = @Content(examples = @ExampleObject(name = "구역 요약 조회 성공 예시", value = """
            {
                "success": true,
                "message": "구역 요약 조회 성공",
                "data": [
