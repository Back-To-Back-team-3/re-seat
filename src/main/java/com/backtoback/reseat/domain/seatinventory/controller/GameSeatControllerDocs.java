...
@Tag(
    name = "Game Seat",
    description = "경기 좌석 현황·구역 조회 API"
)
public interface GameSeatControllerDocs {
    ...
    @Operation(
        ...
        description = """
            ...
            - Queue-Token 검증: validateToken(조회)만 수행.
              ...
              승인 복구가 성공한 경우 PaymentRecoveryService가 finalizeTokenAfterPayment()를 호출한다.
    ...
    ResponseEntity<com.backtoback.reseat.global.common.ApiResponse<List<SeatStatusResponse>>> getSeats(
        ...
        @Parameter(description = "구역 ID (선택)") Long zoneId,

        @Parameter(
            description = "좌석 등급 (선택)",
