...
@Table(
    ...
    indexes = {
        @Index(
            name = "idx_games_game_at",
            columnList = "game_at"
        ),
        @Index(
            name = "idx_games_home_team_game_at",
            columnList = "home_team_id, game_at"
        ),
        @Index(
            name = "idx_games_away_team_game_at",
            columnList = "away_team_id, game_at"
        ),
        @Index(
            name = "idx_games_stadium_game_at",
            columnList = "stadium_id, game_at"
        )
    }
)
