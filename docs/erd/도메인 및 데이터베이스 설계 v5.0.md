...
| seat_browsing_completed_at | DATETIME(6) | NULL | 최초 좌석 선점 완료 시간<br>최초에 한 번만 기록하며 취소 · 재선점 시 유지 |
...
| status | CANCELED | 사용자 또는 시스템 취소 | HOLDING 상태의 사용자 취소·결제 실패 또는<br>CONFIRMED 상태의 경기 전체 취소·관리자 취소 |
